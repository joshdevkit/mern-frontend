  ...
  return (
    <CommonLayout>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                From routine cleanings to advanced dental procedures, we provide
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="multiple">
              ...
              <AccordionItem value="whitening">
                ...
                <AccordionContent className="text-gray-50">
                  Brighten your smile with our safe and effective in-office and
              ...
              <AccordionItem value="implants">
                ...
                <AccordionContent className="text-gray-50">
                  Restore missing teeth with durable and natural-looking dental
              ...
              <AccordionItem value="pediatric">
                ...
                <AccordionContent className="text-gray-50">
                  Specialized dental care for children in a fun and comfortable
                  environment.
                </AccordionContent>
              </AccordionItem>
      ...
      <section className="container py-20 bg-blue-700 text-white text-center">
        ...
        <p className="text-xl mb-8">
          Your oral health is our priority. Book your consultation now and start
